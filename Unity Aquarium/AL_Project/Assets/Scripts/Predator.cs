...
public class Predator : MonoBehaviour
{
    ...
    private float adultAge = 5f, oldAge = 10f;
    ...
    void OnCollisionEnter(Collision col)
    {
        if (reproduce)
        {
            if (col.transform == closestPredator)
            {
                ...
                float r, g, b = 0f;
                r = (parent1Color.r + parent2Color.r) / Random.Range(1.9f, 2.1f) + Random.Range(-0.01f, 0.01f);
                g = (parent1Color.g + parent2Color.g) / Random.Range(1.9f, 2.1f) + Random.Range(-0.01f, 0.01f);
                b = (parent1Color.b + parent2Color.b) / Random.Range(1.9f, 2.1f) + Random.Range(-0.01f, 0.01f);
