...
public class Boid : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        transform.GetChild(0).GetChild(1).GetComponent<Renderer>().material.mainTexture =
        transform.GetChild(0).GetChild(2).GetComponent<Renderer>().material.mainTexture =
        controller.youngPreySkins[currentSkin];
    ...
    private void IncreaseAge()
    {
        ...
        if(age >= adultAge && age < oldAge && !changedAdult)
        {
            ...
            transform.GetChild(0).GetChild(1).GetComponent<Renderer>().material.mainTexture =
            transform.GetChild(0).GetChild(2).GetComponent<Renderer>().material.mainTexture =
            controller.adultPreySkins[currentSkin];
            changedAdult = true;
        }
        else if(age >= oldAge && !changedOld)
        {
            ...
            transform.GetChild(0).GetChild(1).GetComponent<Renderer>().material.mainTexture =
            transform.GetChild(0).GetChild(2).GetComponent<Renderer>().material.mainTexture = 
            controller.oldPreySkins[currentSkin];
            changedOld = true;
        }
    }
    ...
    void OnCollisionEnter(Collision col)
    {
        if (reproduce)
        {
            if (col.transform == closestBoid)
            {
                ...
                // Color Mutation
                Color parent1Color = closestBoid.GetChild(0).GetChild(0).GetComponent<Renderer>().material.color;
                Color parent2Color = transform.GetChild(0).GetChild(0).GetComponent<Renderer>().material.color;
                float r, g, b = 0f;
                ...
                child.transform.GetChild(0).GetChild(0).GetComponent<Renderer>().material.color =
                child.transform.GetChild(0).GetChild(1).GetComponent<Renderer>().material.color =
                child.transform.GetChild(0).GetChild(2).GetComponent<Renderer>().material.color = new Color(r, g, b);
