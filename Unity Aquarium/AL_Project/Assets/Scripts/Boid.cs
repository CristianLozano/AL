...
public class Boid : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        transform.GetChild(0).GetChild(1).GetComponent<Renderer>().material.mainTexture = controller.youngPreySkins[currentSkin];
    ...
    private void IncreaseAge()
    {
        ...
        if(age >= adultAge && age < oldAge && !changedAdult)
        {
            ...
            transform.GetChild(0).GetChild(1).GetComponent<Renderer>().material.mainTexture = controller.adultPreySkins[currentSkin];
            changedAdult = true;
        }
        else if(age >= oldAge && !changedOld)
        {
            currentSkin  = UnityEngine.Random.Range(0, controller.oldPreySkins.Count);
            transform.GetChild(0).GetChild(1).GetComponent<Renderer>().material.mainTexture = controller.oldPreySkins[currentSkin];
            changedOld = true;
        }
    }
    ...
    void OnCollisionEnter(Collision col)
    {
        if (reproduce)
        {
            if (col.transform == closestBoid)
            {
                ...
                // Color Mutation
                Color parent1Color = closestBoid.GetChild(0).GetChild(1).GetComponent<Renderer>().material.color;
                Color parent2Color = transform.GetChild(0).GetChild(1).GetComponent<Renderer>().material.color;
                float r, g, b = 0f;
                r = (parent1Color.r + parent2Color.r) / Random.Range(1.95f, 2.05f) + Random.Range(-0.01f, 0.01f);
                g = (parent1Color.g + parent2Color.g) / Random.Range(1.95f, 2.05f) + Random.Range(-0.01f, 0.01f);
                b = (parent1Color.b + parent2Color.b) / Random.Range(1.95f, 2.05f) + Random.Range(-0.01f, 0.01f);
